...
function QiraArt(){return <div className={`${styles.caseArt} ${styles.qiraArt}`} aria-hidden="true"><div className={styles.qiraCover}><QiraMark className={styles.qiraMarkLarge}/><span>قِرَى</span><strong>QIRĀ</strong><small>ضيافة تنتمي إلى المكان.</small></div><div className={styles.qiraConcept}><span>THE THRESHOLD</span><div className={styles.thresholdSymbol}><i/></div><strong>الفكرة: العتبة</strong><p>لحظة الانتقال من الخارج إلى الداخل، ومن المكان إلى الألفة.</p></div><div className={styles.qiraMaterials}><span>ألوان من المكان، لا عنه</span><div className={styles.qiraSwatches}><i style={{background:'#171512'}}/><i style={{background:'#F2EEE7'}}/><i style={{background:'#8A4B38'}}/><i style={{background:'#4B594E'}}/><i style={{background:'#B28D59'}}/></div></div><div className={styles.qiraApplications}><div className={styles.qiraCardDark}><QiraMark/><b>QIRĀ</b></div><div className={styles.qiraCardLight}><QiraMark/><b>قِرَى</b></div><div className={styles.qiraPhone}><QiraMark/><span>اختر بيتك</span><i/><i/><i/></div></div></div>}
...
export function StudioHomeV4({ locale }: StudioHomeV4Props) {
  ...
  const projects = [
    ...
    { key:'qira', copy:c.work.projects.qira, tag:c.work.concept, art:<QiraArt/>, href:`/${locale}/work/qira` },
