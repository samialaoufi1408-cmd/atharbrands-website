...
function AevuArt() {
  return <div className={styles.caseArt} data-case-art="photograph"><Image src="/assets/studies/aevu/landscape.webp" alt="" width={1536} height={1024} sizes="(max-width: 760px) 100vw, 85vw" style={{width:'100%',height:'100%',objectFit:'cover'}} /></div>;
}
...
export function StudioHomeV4({ locale }: StudioHomeV4Props) {
  ...
  const projects = [
    ...
    { key:'aevu', copy:c.work.projects.aevu, tag:c.work.concept, art:<AevuArt/>, href:`/${locale}/work/aevu` },
