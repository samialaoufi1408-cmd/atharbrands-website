...
export function NaysarMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 180 240" fill="none" aria-hidden="true" className={className}>
      <path d="M65 208C17 195 19 139 40 88C61 37 102 12 132 29C162 46 157 102 136 151C115 200 80 229 48 217" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
